            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 container">
                        <?php echo form_textarea(array('name'=>'deskripsi','class'=>'form-control1','value'=>$r->deskripsi,'style'=>'height:200px;','readonly'=>'readonly')); ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-10 col-sm-offset-2">
                        <input type="submit" name="terima" value="Terima" class="btn btn-primary"> <input type="submit" value="Tolak" name="tolak" class="btn btn-danger"> <a href="<?php echo base_url('home'); ?>" class="btn btn-warning">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
